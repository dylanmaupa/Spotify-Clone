...
const Sidebar = () => {
    return (
        <div className='w-1/4 fixed left-0 top-0 sidebar'>
            ...
            <div className="mt-2 secondary_bg rounded-lg p-2">
                ...
                <div className="your_library">
                    ...
                    <div className="leading-8 mt-6 tertiary_bg rounded-lg py-6 px-4">
            ...
            <button className="mt-8 mx-4 text-sm font-bold border-white border rounded-full flex gap-1 items-center px-3 py-1 text-white">
                <TbWorld />
                English
            </button>
            <Signup />
